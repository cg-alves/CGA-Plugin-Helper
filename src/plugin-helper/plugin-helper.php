...
function cgaph_installer_menu() {
    ...
    include_once ( 'cgaph-plugin-main.php' );
    add_menu_page( __( 'Plugin Helper', 'cga-plugin-helper' ), __( 'Plugin Helper', 'cga-plugin-helper' ), 'manage_options', 'plugin-installer', 'cgaph_landing_page', 'dashicons-admin-generic', 200  );
